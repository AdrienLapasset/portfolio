...
function Background() {
	return (
		...
		>
			<g stroke="#000" strokeWidth="4" strokeLinecap="round" fill="none" fillRule="evenodd">
				{/* CODE BLOCK */}

				<path
					className="codeBlock__contour"
				...
				/>
				<path className="codeBlock__contour" d="M316.5208,45.8111 L335.3598,26.9721" id="Stroke-7" />
				<polyline
					className="codeBlock__contour"
					id="Stroke-9"
					points="449.3152 256.0347 461.6562 268.3757 449.3202 280.7127"
				/>
				<path className="codeBlock__contour" d="M301.1479,74.7341 L359.2029,74.7341" id="Stroke-11" />
				<path className="codeBlock__contour" d="M334.1632,45.7341 L466.3302,45.7341" id="Stroke-13" />
				<path className="codeBlock__contour" d="M300.2899,91.2341 L391.7029,91.2341" id="Stroke-15" />
				<path
					className="codeBlock__contour"
					...
					id="Stroke-53"
				/>
				<path className="codeBlock__contour" d="M300.2899,108.2341 L374.7029,108.2341" id="Stroke-17" />
				<path
					className="codeBlock__contour"
				...
				<path
					...
					id="Stroke-21"
				/>
				<path className="codeBlock__contour" d="M329.0208,156.781 L366.3298,156.781" id="Stroke-23" />
				<path className="codeBlock__contour" d="M351.6632,198.7758 L351.6632,262.6928" id="Stroke-25" />
				<path className="codeBlock__contour" d="M406.6289,230.7341 L364.2859,230.7341" id="Stroke-27" />
				<path className="codeBlock__contour" d="M445.9071,212.2341 L363.6501,212.2341" id="Stroke-29" />

				{/* FIRST LINE */}
				<path className="line__first" d="M452.1731,310.3175 L452.1731,482.5675" id="Stroke-69" />
				<path
					className="line__first__point"
				...
				/>
				<g className="codeBlock__contour" id="Group-76">
					<g transform="translate(452.000000, 523.145000)">
						<polyline
							className="cube"
							id="Fill-74"
							stroke="none"
							fill="#000"
							fillRule="evenodd"
							points="0.1731 21.3965 0.1731 62.0895 36.7891 39.6155 36.7891 0.0215"
						/>
						<polyline
							id="Stroke-75"
							fill="none"
				...
				<path
					className="codeBlock__contour"
					d="M160.591,298.6817 L21.486,298.6817 C10.769,298.6817 2,307.4507 2,318.1677 L2,578.6587 C2,589.3767 10.769,598.1447 21.486,598.1447 L207.576,598.1447 C218.294,598.1447 227.062,589.3767 227.062,578.6587 L227.062,487.8217"
					id="screen-block"
				/>
